...
- **🏛️ Tax Calculation**: Automatically calculates the necessary gross salary to cover your net expenses after taxes.
...
- **🏗️ Template-based**: Clean DOM manipulation using the `<template>` element for better performance and maintainability.

## 🛠️ How to Use

1.  **⚙️ Configure**: Set your base currency and your local tax rate.
...
---
Made with ❤️ by [aneuhaus](https://github.com/aneuhaus)
